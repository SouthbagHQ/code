...
Stateful agent with tool execution and event streaming. Built on `@southbag/code-ai`.

## Installation

```bash
npm install @southbag/code-core
```

## Quick Start

```typescript
import { Agent } from "@southbag/code-core";
...
```typescript
declare module "@southbag/code-core" {
...
```typescript
import { Agent, streamProxy } from "@southbag/code-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@southbag/code-core";
