...
```typescript
import type { ExtensionAPI } from "@southbag/code";
...
| Package | Purpose |
|---------|---------|
| `@southbag/code` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@southbag/code-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@southbag/code-tui` | TUI components for custom rendering |
...
Fired when the model is restored from a session.
...
```typescript
import { isToolCallEventType } from "@southbag/code";
...
```typescript
import { isBashToolResult } from "@southbag/code";
...
```typescript
import { createLocalBashOperations } from "@southbag/code";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@southbag/code";
...
```typescript
import { SessionManager } from "@southbag/code";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@southbag/code-ai";
...
```typescript
import type { AutocompleteItem } from "@southbag/code-tui";
...
```typescript
import { withFileMutationQueue } from "@southbag/code";
...
import { Type } from "typebox";
import { StringEnum } from "@southbag/code-ai";
import { Text } from "@southbag/code-tui";
...
**Important:** Use `StringEnum` from `@southbag/code-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@southbag/code";
...
```typescript
import { createBashTool } from "@southbag/code";
...
```typescript
import { keyHint } from "@southbag/code";
...
```typescript
import { Text, Component } from "@southbag/code-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@southbag/code";
import { matchesKey } from "@southbag/code-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@southbag/code";
