import { createAssistantMessageEventStream, Type } from "@southbag/code-ai";
import { complete, getModel, getProviders } from "@southbag/code-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
