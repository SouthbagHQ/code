import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@southbag/code";
import type { Component, EditorTheme, TUI } from "@southbag/code-tui";
import { truncateToWidth, visibleWidth } from "@southbag/code-tui";
