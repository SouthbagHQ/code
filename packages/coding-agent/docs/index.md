...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @southbag/code`, `yarn global remove @southbag/code`, or `bun uninstall -g @southbag/code`.
