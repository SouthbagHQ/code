...
These commands manage pi packages. To update or uninstall pi itself, see [Quickstart](quickstart.md).
...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@southbag/code-ai`, `@southbag/code-core`, `@southbag/code`, `@southbag/code-tui`, `typebox`.
