...
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@southbag/code-ai/compat";
import { completeSimple } from "@southbag/code-ai/compat";
import type { AgentMessage, StreamFn, ThinkingLevel } from "@southbag/code-core";
import {
	convertToLlm,
