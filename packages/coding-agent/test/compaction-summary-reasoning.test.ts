import type { AssistantMessage, Model } from "@southbag/code-ai";
...
vi.mock("@southbag/code-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@southbag/code-ai/compat")>();
	return {
		...actual,
